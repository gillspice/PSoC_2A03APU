...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=3, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=255, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=8, RunMode=1, UDB16=false, UDB24=false, UDB32=false, UDB8=true, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Length_Counter_1, CY_INSTANCE_SHORT_NAME=Length_Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Length_Counter_1, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0\Count7_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.1\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Count7_v1_0\Count7_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Triangle_Gen"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Triangle_Gen\Triangle_Gen.v"
`else
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Triangle_Gen"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Triangle_Gen\Triangle_Gen.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Linear_Counter"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Linear_Counter\Linear_Counter.v"
`else
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Linear_Counter"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Linear_Counter\Linear_Counter.v"
`endif

// VDAC8_v1_90(Data_Source=1, Initial_Value=100, Strobe_Mode=1, VDAC_Range=4, VDAC_Speed=2, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_Noise, CY_INSTANCE_SHORT_NAME=VDAC8_Noise, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=VDAC8_Noise, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Sampler"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Sampler\Sampler.v"
`else
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Sampler"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\Sampler\Sampler.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\clock_divider"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\clock_divider\clock_divider.v"
`else
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\clock_divider"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\clock_divider\clock_divider.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\component01"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\component01\component01.v"
`else
`define CY_BLK_DIR "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\component01"
`include "C:\github\PSoC_2A03APU\APU2A03\APU2A03.cydsn\component01\component01.v"
`endif
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DefSi=0, Direction=1, FifoSize=4, InterruptSource=0, Length=16, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, UseInputFifo=false, UseInterrupt=false, UseOutputFifo=false, UseShiftIn=false, UseShiftOut=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=rectangle_generator, CY_INSTANCE_SHORT_NAME=rectangle_generator, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=rectangle_generator, )
